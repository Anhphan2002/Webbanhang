...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">LDD Phone Store</a> - All rights reserved © 2020 - Designed by phantuananh
            ...
            <div class="tab-content">
                ...
                <div id="signup">
                    ...
                    <form onsubmit="return signUp(this);">
                        ...
                        <div class="field-wrap">
                        <label>
                            Địa chỉ nhận hàng<span class="req">*</span>
                        </label>
                        <input name="address" type="address" required autocomplete="off" />
                        </div> <!-- /address -->                     
